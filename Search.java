...
*                             MEMBER METHODS                                   *
*******************************************************************************/
	public  static double[][] cityToArray()
    {
		
		double [][] cityArray = new double[48][2];
        try {
            // Open the file
            File file = new File("university-of-state-list.txt");
...
*******************************************************************************/
	...
	//	an else_if block below to instantiate the problem.
		...
		if (Parameters.problemType.equals("NM")){
			...
			double[][] cityArray = cityToArray();
            problem = new TSP(cityArray);
		}
